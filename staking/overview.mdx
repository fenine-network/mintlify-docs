...
<AccordionGroup>
  ...
  <Accordion title="2. Reward Tax Burn">
    ...
    $$
    B_{\\text{tax}} = R_{\\text{claimed}} \\times 0.10 \\times 0.50
    $$
    
    **Annual Burn** (if 50% of rewards claimed):
    
    $$
    B_{\\text{tax}} \\approx 263,000 \\text{ FEN}
    $$
  </Accordion>
  ...
  <Accordion title="Net Inflation">
    ...
    **Scenarios**:
    ...
    |------------------|----------|---------------|---------------|
    | Low | 1 gwei | 158K FEN | +10.1M (+10.1%) |
    | Medium | 10 gwei | 1.58M FEN | +8.68M (+8.7%) |
    | **High** | **67 gwei** | **10.6M FEN** | **-343K (-0.3%)** |
    | Very High | 100 gwei | 15.8M FEN | -5.54M (-5.5%) |
